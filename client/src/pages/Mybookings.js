...
const MyBookings = () => {
    const {state: { user, isLoading, alert}, dispatch} = useContext( context )
        ...
        <div className="container">
            ...
            <section className="roomsList">
                <div className="roomsList-center">
                    {bookedRooms.map(room => <BookedRoom room={room} key={room._id}  bookedRooms={bookedRooms} setBookedRooms={setBookedRooms}/>)}
                </div>
            </section>
            }   
        </div>
